...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/whitequark/parser/issues", "changelog_uri" => "https://github.com/whitequark/parser/blob/v3.2.1.0/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/parser/3.2.1.0", "source_code_uri" => "https://github.com/whitequark/parser/tree/v3.2.1.0" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<racc>.freeze, ["= 1.6.1"])
      ...
      s.add_dependency(%q<racc>.freeze, ["= 1.6.1"])

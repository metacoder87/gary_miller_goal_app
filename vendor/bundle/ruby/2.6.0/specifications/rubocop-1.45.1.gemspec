...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubocop/rubocop/issues", "changelog_uri" => "https://github.com/rubocop/rubocop/blob/master/CHANGELOG.md", "documentation_uri" => "https://docs.rubocop.org/rubocop/1.45/", "homepage_uri" => "https://rubocop.org/", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rubocop/rubocop/" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<parser>.freeze, [">= 3.2.0.0"])
      ...
      s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.24.1", "< 2.0"])
      ...
      s.add_dependency(%q<parser>.freeze, [">= 3.2.0.0"])
      ...
      s.add_dependency(%q<rubocop-ast>.freeze, [">= 1.24.1", "< 2.0"])
